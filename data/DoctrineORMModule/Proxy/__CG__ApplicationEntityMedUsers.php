 ...
 */
class MedUsers extends \Application\Entity\MedUsers implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'username', 'imieNazwisko', 'email', 'color', 'active', 'ip', 'room');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (MedUsers $proxy) {
    ...
    public function setImieNazwisko($imieNazwisko)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setImieNazwisko', array($imieNazwisko));

        return parent::setImieNazwisko($imieNazwisko);
    }
    ...
    public function getImieNazwisko()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getImieNazwisko', array());
